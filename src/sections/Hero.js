...
export default function Hero() {
  return (
    <div className="mx-auto max-w-screen-1200px  h-screen flex items-center justify-center sm:max-w-600px hero">
      <div className="text-5xl p-3 m-3 text-mainGreen font-rubik font-bold w-2/3 flex flex-col border-2 border-mainGray md:text-8xl bg-gradient-to-r from-gray-500 via-stone-300 to-gray-500">
